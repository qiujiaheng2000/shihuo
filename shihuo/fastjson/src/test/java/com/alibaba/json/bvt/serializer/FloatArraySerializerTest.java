...
public class FloatArraySerializerTest extends TestCase {
    ...
    public void test_0() {
        ...
        Assert.assertEquals("[1,2]", JSON.toJSONString(new float[] { 1, 2 }));
        Assert.assertEquals("[1,2,3]", JSON.toJSONString(new float[] { 1, 2, 3 }));
        Assert.assertEquals("[1,2,3,null,null]", JSON.toJSONString(new float[] { 1, 2, 3, Float.NaN, Float.NaN }));
    }
