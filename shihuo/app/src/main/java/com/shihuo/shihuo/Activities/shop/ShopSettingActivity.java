...
public class ShopSettingActivity extends BaseActivity {
    ...
    @OnClick({R.id.imag_left, R.id.layout_servicenum, R.id.layout_shop_desc, R.id.layout_notice, R.id.layout_pic, R.id.layout_free_of_charge, R.id.layout_qr_code, R.id.layout_delivery_time, R.id.layout_business_time, R.id.layout_shop_address})
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.layout_delivery_time:
                SettingEditActivity.start(this,SettingEditActivity.FLAG_SETTING_SHOP_DILIVERY_TIME);
                break;
            case R.id.layout_business_time:
                SettingEditActivity.start(this,SettingEditActivity.FLAG_SETTING_SHOP_BUSINESS_TIME);
                break;
