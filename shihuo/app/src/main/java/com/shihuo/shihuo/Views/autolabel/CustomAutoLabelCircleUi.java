...
public class CustomAutoLabelCircleUi extends AutoLabelUI {
    ...
    public CustomAutoLabelCircleUi(Context context) {
        super(context);
    }

    public CustomAutoLabelCircleUi(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CustomAutoLabelCircleUi(Context context, AttributeSet attrs, int defStyle) {
